...
Begin VB.Form frmUserCrack 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Remote System UseName Cracker"
   ClientHeight    =   4710
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5430
   ...
   End
End
Attribute VB_Name = "frmUserCrack"
...
If Text1.Text = "9.22.56.0" Then
Ip = "9.22.56.0"
Hostname = "Kroger Foods"
Password = "strun"
Call Scan
End If
...
Pause (1)
Text2.Text = Text2.Text & "" & vbCrLf
Text2.Text = Text2.Text & "Starting UserName Cracker" & vbCrLf
Pause (1)
Text2.Text = Text2.Text & "" & vbCrLf
Text2.Text = Text2.Text & "==========================================" & vbCrLf
Pause (1)
...
Text2.Text = ""
Pause (0.3)
Text2.Text = Text2.Text & "UserName Cracking Complete:" & vbCrLf
Pause (0.3)
Text2.Text = Text2.Text & "" & vbCrLf
Pause (0.3)
Text2.Text = Text2.Text & "UserName = " & Password & vbCrLf
